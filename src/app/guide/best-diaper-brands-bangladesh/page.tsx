...
const BRAND_INFO: Record<string, {
  ...
  kidz:        { name: "Kidz",        nameBn: "কিডজ",        origin: "জার্মানি",           type: "বেল্ট + প্যান্ট", verdict: "জার্মানিতে তৈরি বলে দাবি করে, দামও বিদেশি ব্র্যান্ডের কাছাকাছি (৩২-৬২ টাকা/পিস)। S সাইজ নেই, নবজাতক থেকে সরাসরি M-এ যায়।", bestFor: "প্রিমিয়াম বাজেটে বিদেশি বিকল্প" },
};

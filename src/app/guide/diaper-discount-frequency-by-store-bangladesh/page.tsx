...
export const metadata: Metadata = {
  ...
  description:
    "১০টা দোকানের লাইভ ডেটায় কোথায় সবচেয়ে বেশি ডায়াপার প্রমোশনে থাকে, গড় ডিসকাউন্ট কত, আর কতবার 'প্রমোশন' ব্যাজ থাকা প্রোডাক্টও আসলে সেই ব্র্যান্ড-সাইজে সবচেয়ে সস্তা না, তা সরাসরি ডেটাবেস থেকে হিসাব করে দেখানো হয়েছে।",

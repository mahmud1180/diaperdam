...
export const metadata: Metadata = {
  ...
  description:
    "ডায়াপার র‍্যাশ বেশিরভাগ সময় ভেজা ডায়াপার বেশিক্ষণ থাকলেই হয়। বাংলাদেশের গরমে আরও বাড়ে। কত ঘন ঘন বদলাবেন, কোন ক্রিম, কখন ডাক্তার, আর ঘন ঘন বদলালে প্রতি পিস দাম যেহেতু সবচেয়ে জরুরি, আজ ১০ দোকানে সবচেয়ে কম দামের ডায়াপার কোনগুলো, সব এক পাতায়।",
      ...
      <div>
        ...
        <article className="max-w-3xl mx-auto px-4 py-8 text-slate-700 leading-relaxed">
          ...
          <p className="mb-4">
            ...
            আমরা DiaperDam-এ প্রতিদিন চালডাল, দারাজ, স্বপ্নসহ ১০টা দোকানের দাম টেনে এনে সবকিছু প্রতি পিস দামে

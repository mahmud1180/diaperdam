...
export const metadata: Metadata = {
  ...
  description:
    "নবজাতক (NB) ডায়াপার সাইজ ৫ কেজি পর্যন্ত। প্রথম মাসে দিনে ৮-১২টা লাগে। কয় প্যাক কিনবেন, কখন সাইজ S-এ যাবেন, আর আজ বাংলাদেশের ১০টা দোকানে নবজাতক ডায়াপারের সবচেয়ে কম দাম কত, সব এক পাতায়।",
      ...
      <div>
        ...
        <article className="max-w-3xl mx-auto px-4 py-8 text-slate-700 leading-relaxed">
          ...
          <p className="mb-4">
            ...
            প্রতিদিন চালডাল, দারাজ, স্বপ্নসহ ১০টা দোকানের দাম টেনে এনে সব প্যাক প্রতি পিস দামে সাজাই।
          </p>
